...
filePath <- "~/Downloads/"
data <- fread(paste0(filePath,"QVI_data (1).csv"))
...
measureOverTime <- data[, .(totSales = sum(TOT_SALES),
 ...
 , by = .(STORE_NBR, YEARMONTH)][order(STORE_NBR, YEARMONTH, totSales)]
...
ggplot(trialAssessment, aes(TransactionMonth, nCusts, color = Store_type)) +
 ...
 geom_line() +
 labs(x = "Month of operations", y = "Numbers of customers", title = "Numbers of customers by month")
```
...
ggplot(pastSales, aes(TransactionMonth, totSales, color = Store_type)) +
 geom_line() +
 labs(x = "Month of opertaions", y = "Total sales", title = "Total sales by month")
```
